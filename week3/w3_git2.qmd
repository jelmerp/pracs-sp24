...
subtitle: "Week 3 - Version Control - Part II"
pagetitle: "PRACS24: Git remotes"
...
We will use the **GitHub website**^[
GitHub is the most widely used but not the only website that hosts Git repositories --
others include *GitLab*, *Bitbucket*, and *SourceForge*.]
as the place to host our online repositories.
Online counterparts of our local repositories are usually
referred to as "remote repositories" or simple "**remotes**".

Using remote repositories will add a couple of Git commands to our toolbox:
...
2. On the GitHub website, click the **`+`** next to your avatar (top-right) and
...
4. Leave other options as they are, as shown below, and click "**Create repository**":
...
Also, you can check your remote connection settings for a repo with `git remote -v`:
...
Back at GitHub, click where it says `<> Code` in the lower of the top bars:
