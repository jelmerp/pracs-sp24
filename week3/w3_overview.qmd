...
- Tuesday -- [Getting started with Git](w3_git1.qmd).
- Thursday -- [Remotes on GitHub](w3_git2.qmd).
- Bonus (optional self-study) content:
  [Branching, collaborating, and undoing](w3_git3.qmd).

#### Exercises & assignments

- **Make sure you have done the assignment from week 2 by Tuesday:**
  [**Create a GitHub account**](../week2/w2_github-account.qmd).
...
::: callout-tip
#### Final project
You should start thinking about your final project for this course ---
recall that this is the only part of the course that is graded.

- Take a look at the [page with general info on the final project](../finalproj/info.qmd).
- Your [proposal (plan)](../finalproj/proposal.qmd) is due on Monday, April 1st (week 5).
